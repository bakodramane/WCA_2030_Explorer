...
function makeEmbedding(...leading) {
...
const SECTION_MOCK_CHUNKS = [
    ...
    { id: 'fm1', sectionTitle: 'FRONT MATTER', pageRef: 1, text: 'table of contents essential items list census', priority: 'normal', embedding: makeEmbedding(0.9) },
    { id: 'fm2', sectionTitle: 'FRONT MATTER', pageRef: 5, text: 'list of items for the census essential', priority: 'normal', embedding: makeEmbedding(0.9) },
    ...
    { id: 'sx1', sectionTitle: 'SECTION X', pageRef: 15, text: 'section x chunk one agricultural holdings', priority: 'normal', embedding: makeEmbedding(0.375) },
    { id: 'sx2', sectionTitle: 'SECTION X', pageRef: 15, text: 'section x chunk two land use data', priority: 'normal', embedding: makeEmbedding(0.375) },
    { id: 'sx3', sectionTitle: 'SECTION X', pageRef: 15, text: 'section x chunk three census methodology', priority: 'normal', embedding: makeEmbedding(0.375) },
    // SECTION Y: 1 chunk (avg=0.48 > SECTION X avg=0.3). Fix 1.
    { id: 'sy1', sectionTitle: 'SECTION Y', pageRef: 20, text: 'section y single chunk high quality', priority: 'normal', embedding: makeEmbedding(0.6) },
    // SECTION Z: 2 chunks (avg=(0.4+0.24)/2=0.32). Fix 1 two-chunk test.
    { id: 'sz1', sectionTitle: 'SECTION Z', pageRef: 30, text: 'section z first chunk items holdings', priority: 'normal', embedding: makeEmbedding(0.5) },
    { id: 'sz2', sectionTitle: 'SECTION Z', pageRef: 31, text: 'section z second chunk data census', priority: 'normal', embedding: makeEmbedding(0.3) },
    ...
    { id: 'bg1', sectionTitle: 'BIG SECTION', pageRef: 1, text: 'big section start high relevance', priority: 'normal', embedding: makeEmbedding(0.8) },
    { id: 'bg2', sectionTitle: 'BIG SECTION', pageRef: 50, text: 'big section end high relevance', priority: 'normal', embedding: makeEmbedding(0.8) },
    // ESSENTIAL ITEMS: title matches "essential items" query → boost. Fix 3.
    { id: 'es1', sectionTitle: 'ESSENTIAL ITEMS', pageRef: 64, text: 'essential items agricultural census methodology', priority: 'normal', embedding: makeEmbedding(0.52) },
    // OTHER DATA: title contains "data" (4 chars, not stop word) → boosted by
    // "data census" query but not by "essential items" query. Fix 3.
    { id: 'od1', sectionTitle: 'OTHER DATA', pageRef: 70, text: 'other agricultural data collection', priority: 'normal', embedding: makeEmbedding(0.55) },
];
// ── Test suite ─────────────────────────────────────────────────────────────────
describe('RetrievalEngine', () => {
    ...
    beforeAll(async () => {
        ...
        vi.mocked(pipeline).mockResolvedValue(mockExtractor);
...
describe('RetrievalEngine — section methods', () => {
    ...
    beforeAll(async () => {
        ...
        vi.mocked(pipeline).mockResolvedValue(mockExt);
    ...
    describe('sectionSearch', () => {
        ...
        describe('fallback when all sections exceed 40 pages', () => {
            ...
            beforeAll(async () => {
                const ALL_BIG = [
                    { id: 'ab1', sectionTitle: 'ALPHA', pageRef: 1, text: 'alpha start', priority: 'normal', embedding: makeEmbedding(0.8) },
                    { id: 'ab2', sectionTitle: 'ALPHA', pageRef: 60, text: 'alpha end', priority: 'normal', embedding: makeEmbedding(0.7) },
                    { id: 'bb1', sectionTitle: 'BETA', pageRef: 2, text: 'beta start', priority: 'normal', embedding: makeEmbedding(0.6) },
                    { id: 'bb2', sectionTitle: 'BETA', pageRef: 80, text: 'beta end', priority: 'normal', embedding: makeEmbedding(0.5) },
                ];
                vi.stubGlobal('fetch', vi.fn().mockResolvedValue({
                ...
                const vec = new Float32Array(DIM);
                vec[0] = 0.8;
                vi.mocked(pipeline).mockResolvedValue(vi.fn().mockResolvedValue({ data: vec }));
